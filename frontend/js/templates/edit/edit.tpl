<div class='new__form'>
	<div class="form__container center-block">
		<p class="new__header"> Редактировать товар </p>
		<div>
			<div class="new__field">
	  		...
	  		<div class="new__field">
		  		<div class="btn-group">
				  <button id='group' type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="caret"></span>
				  </button>
